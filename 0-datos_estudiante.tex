...
% -------------------------------------------------------------------------------
% Nombre completo
\def \nombreestudiante {José Alejandro Prince Martinez}
% Carné
\def \uvgcarne {22087}
% Facultad
...
% -------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Análisis sobre la percepción de uso de IA en videojuegos mediantes pruebas A/B aplicado a trabajo profesional - Desarrollo de mecánicas principales medinate IA}
% Año de entrega
\def \anoentrega {2026}
% Asesor
\def \nombreasesor {Ing. Dennis Aldana}
